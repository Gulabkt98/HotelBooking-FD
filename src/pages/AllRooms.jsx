...
const AllRooms = () => {
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row item-start justify-between pt-28 md:pt-35 px-16 lg:px-24 xl:px-32'>
     ...
     <div>
       ...
       {roomsDummyData.map((room)=>(
        <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
            ...
            src={room.images[0]} alt="hotel--imag" title='View Room Details' className='
            ...
            <div className='md:w-1/2 flex flex-col gap-2'>
                ...
                {/* Room Amenities */}
                <div className='flex flex-wrap item-center mt-3 mb-6 gap'>
                   {room.amenities.map((item,index)=>(
                    <div key={index} className='flex items-center gap-2 px-3 py-2 rounded-lg bg-amber-50' >
     ...
     {/* Filters */}<div className='bg-white w-80 border border-gray-300 text-gray-600 min-h-40 max-h-[500px] overflow-y-auto'>
